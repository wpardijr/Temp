...
void NCursesDisplay::DisplaySystem(System& system, WINDOW* window) 
{
	...
	wprintw(window, ProgressBar(system.Cpu().Utilization(1000)).c_str());
	...
	wattron(window, COLOR_PAIR(1)); 
	mvwprintw(window, row, 10, "");
	wprintw(window, ProgressBar(system.Cpu().Utilization(1)).c_str());
	wattroff(window, COLOR_PAIR(1));
	
	mvwprintw(window, ++row, 2, "CPU2: ");
	wattron(window, COLOR_PAIR(1)); 
	mvwprintw(window, row, 10, "");
	wprintw(window, ProgressBar(system.Cpu().Utilization(2)).c_str());
	wattroff(window, COLOR_PAIR(1));
	
	mvwprintw(window, ++row, 2, "CPU3: ");
	wattron(window, COLOR_PAIR(1)); 
	mvwprintw(window, row, 10, "");
	wprintw(window, ProgressBar(system.Cpu().Utilization(3)).c_str());
	wattroff(window, COLOR_PAIR(1));
